...
maybe_sudo mkdir -p "/usr/share/nginx/html/nginx-hibernator-frontend"
unzip -o "/tmp/frontend.zip" -d "/tmp/frontend-extract"
maybe_sudo mv /tmp/frontend-extract/*/* "/usr/share/nginx/html/nginx-hibernator-frontend/"
...
maybe_sudo mkdir -p "/usr/share/nginx/html/nginx-hibernator-landing"
unzip -o "/tmp/landing.zip" -d "/tmp/landing-extract"
maybe_sudo mv /tmp/landing-extract/*/* "/usr/share/nginx/html/nginx-hibernator-landing/"
rm -rf "/tmp/landing-extract"
